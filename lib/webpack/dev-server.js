...
const websocketPath = "/webpack-dev-server",
    defaultOptions = {
        "server": {
            "type": "https",
            "options": {
        ...
        "client": {
            ...
            "webSocketURL": `auto://0.0.0.0:0${ websocketPath }`,
        },
        "headers": {
            ...
            this.#options.proxy = [
                {
                    ...
                    "changeOrigin": true,
                    "ws": true,
                    "secure": false, // do not verify TLS certificate
                    context ( path ) {
                        if ( path === websocketPath ) return false;
